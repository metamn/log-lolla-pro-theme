...
$url   = log_lolla_pro_theme_get_post_link_from_content();
$klass = log_lolla_pro_theme_get_post_format_link_class( $url );
$title = log_lolla_pro_theme_get_post_format_link_title( $url );
